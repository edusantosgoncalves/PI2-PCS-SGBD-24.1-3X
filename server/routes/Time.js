...
// ! Definindo as rotas de times
router.get("/api/times", TimeController.getTimes); // . Retorna todos os times
router.get("/api/timesAtivos", TimeController.getTimesAtivos); // . Retorna todos os times ativos
router.get("/api/times/:id", TimeController.getTimeById); // . Retorna um time específico
router.get("/api/time/:id", TimeController.getTimeById); // . Retorna um time específico
...
router.put("/api/times/:id/nome", TimeController.atualizaNomeTime); // . Atualiza o nome de um time específico
...
router.get(
  "/api/times/:id/projetosAtivos",
  TimeController.getProjetosAtivosTime
); // . Retorna a qtd de projetos ativos de um time
