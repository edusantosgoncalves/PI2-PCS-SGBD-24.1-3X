...
const UsuarioController = require("../controllers-old/UsuarioController");
const router = Router();
...
); // ! Adiciona uma avaliação de um usuario

//Relacionado a entretenimento:
router.get(
  "/api/usuarios/:email/entretenimento",
  UsuarioController.getEntretenimentoByEmail
); // Busca avaliações de um usuario (avaliado)
router.put(
  "/api/usuarios/:email/entretenimento",
  UsuarioController.vrfEntretenimento
); // Busca avaliações de um usuario (avaliado)
